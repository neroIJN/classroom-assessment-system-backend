...
app.use(cors({
    origin: ['http://localhost:3000', 'http://localhost:3001','http://47.128.238.249:3001' ,'http://47.128.238.249:3000', 'https://assignment-sys-frontend.vercel.app/', 'https://software-project-admin.vercel.app/' ], // Allow requests from localhost:3000
