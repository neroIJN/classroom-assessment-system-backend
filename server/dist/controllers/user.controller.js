...
exports.updateUserRepeatBatch = exports.getUserByIdController = exports.getUserInfo = exports.updateAccessToken = exports.logoutUser = exports.loginUser = exports.activateUser = exports.createActivationToken = exports.registrationUser = void 0;
...
exports.registrationUser = (0, catchAsyncError_1.CatchAsyncError)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const isRegistrationNumberExist = yield user_model_1.default.findOne({
            registrationNumber,
        });
        if (isRegistrationNumberExist) {
            return next(new ErrorHandler_1.ErrorHandler("Registration number already exists", 400));
        }
        const user = {
            name,
            email,
...
exports.loginUser = (0, catchAsyncError_1.CatchAsyncError)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!registrationNumber || !password) {
            return next(new ErrorHandler_1.ErrorHandler("Please enter registration number and password", 400));
        }
        const user = yield user_model_1.default
            .findOne({ registrationNumber })
            .select("+password");
        if (!user) {
            return next(new ErrorHandler_1.ErrorHandler("Invalid registration number or password", 400));
        }
...
exports.getUserByIdController = (0, catchAsyncError_1.CatchAsyncError)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const user = yield (0, user_service_1.getUserByIdService)(res, userId);
        if (!user) {
...
exports.updateUserRepeatBatch = (0, catchAsyncError_1.CatchAsyncError)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = req.params.id;
        const { repeatingBatch, isRepeater } = req.body;
        const user = yield (0, user_service_1.updateUserRepeatBatchService)(res, userId, repeatingBatch, isRepeater);
        if (!user) {
            return next(new ErrorHandler_1.ErrorHandler("User not found", 404));
        }
        res.status(200).json({
